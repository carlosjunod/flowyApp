...
## Authorized publication — 2026-09-14

Implementation `d43136170d21cfb83b18a0206a3024433465cf74` is on `main`. The paired server implementation `9ab570d93f81d4ca6db7ffa1e188754f833a8a23` is live in Railway web deployment `78a876aa-0ff4-4807-83b0-767590ca77fd`. Native TypeScript passes in the clean release worktree `/tmp/flowyApp-inbox-layout-release`; unrelated local edits are excluded. EAS accepted iOS production `1.0.0 (26)`, build `20109da7-8eb8-43ad-8c65-f6ba395e46c4`, with automatic TestFlight submission `54219488-d0c5-4265-af6f-67d6f60ac87a`. Build and submission both reached FINISHED without errors. The signed binary was delivered to App Store Connect for TestFlight; Apple processing/tester availability is not asserted. Existing signing credentials and production environment are reused; no OTA or App Store review submission was requested.
