...
export const api = {
  ...
  listItems: (params: { tag?: string; author?: string; q?: string; category?: string; sort?: string; direction?: string; page?: number; perPage?: number; unread?: boolean; reading?: ReadingFilter }) => {
